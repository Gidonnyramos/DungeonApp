...
namespace DungeonLibrary
{
    public class Rabbit : Monster
    {
        ...
        //Below we hijack the default ctor to provide some hardcoded, default values for a basic Rabbit
        public Rabbit()
        {
        ...
        public override int CalcBlock()
        {
            ...
            //Typically when dealing with a method that has a return type, we will create a variable of that type, then create the return, then add the necessary functionality between the variable's declaration and the return
