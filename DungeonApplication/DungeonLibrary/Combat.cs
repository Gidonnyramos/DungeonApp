...
namespace DungeonLibrary
{
    public class Combat
    {
        ...
        public static void DoAttack(Character attacker, Character defender)
        {
            ...
            //Then we will compare the dice roll against the Attacker's hitChance - defender's calcBlock(). If the dice roll is lower than that algorithm, the attacker hit for damage.
